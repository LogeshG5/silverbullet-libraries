...
local menus = {
    main = {
        ...
        { icon = icons.cleanup,     cmd = "Editor: Format"},
...
local isMobile = js.window.innerWidth < 1090 or js.window.navigator.userAgent:match("Android|iPhone|iPad")
if isMobile then
   initToolbar()
end
```
