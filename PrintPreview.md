---
name: "Library/LogeshG5/PrintPreview"
tags: meta/library
...
local function selectCustomCSS()
  ...
  local blocked = {
    ["Library/LogeshG5/classic.css"] = true,
    ["Library/LogeshG5/data.css"] = true,
    ["Library/LogeshG5/code.css"] = true
  }
...
command.define {
  ...
  run = function()
    ...
    if mode == "classic" then
      cssFile = "Library/LogeshG5/classic.css"
    elseif mode == "code" then
      cssFile = "Library/LogeshG5/code.css"
    elseif mode == "data" then
      cssFile = "Library/LogeshG5/data.css"
